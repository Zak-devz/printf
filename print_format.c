...
/**
  ...
  *
  * Return: The length of the printed format
  */
...
/**
  ...
  * @format: The format specifier to prints
  * @args: A list of variadic arguments
  *
  * Return: The length of the printed specifier
  */
...
/**
  ...
  *
  * Return: The updated count after printing the error message
  */
